...
exclude_patterns = [
    "api/lightning_transformers.rst",
    "api/modules.rst",
...
texinfo_documents = [
    (
        ...
        author,
        project,
        lightning_transformers.__docs__,
        "Miscellaneous",
    ),
]
...
PACKAGES = [
    lightning_transformers.__name__,
]
